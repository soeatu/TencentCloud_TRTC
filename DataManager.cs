...
{
    /// <summary>
    /// iniローカルストレージを使用した、SDKのローカルデータ情報
    /// </summary>
    ...
    class IniStorage
    {
        ...
        {
            // section=コンフィギュレーションセクション，key=键名，value=键值，path=路径
        ...
        public string GetValue(string section, string key)
        {
            ...
            // section=コンフィギュレーションセクション，key=键名，temp=上面，path=路径
